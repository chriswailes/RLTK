class KazooContractor < RLTK::CG::Contractor
	attr_reader :module
	...
	on If do |node|
		...
		merge_bb = fun.blocks.append('merge', self) { phi RLTK::CG::DoubleType, {new_then_bb => then_value, new_else_bb => else_value}, 'iftmp' }
